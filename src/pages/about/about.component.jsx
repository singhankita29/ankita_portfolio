            ...
            <Col xs={12} md={6}>
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                 <div>
                  ...
                  <div>
                    <a>
                      <Button href="https://drive.google.com/file/d/1YnR4y7ZygTyvSCd2HHiRNBILvamBs-N6/view?usp=sharing" target="_blank" className="m-2" variant="outline-success">
                        My Resume
                      </Button>
                    </a>
                  </div>
                  <div>
                   <a>
                      <Button href="https://github.com/singhankita29" target="_blank" className="m-2" variant="outline-dark">
                        GitHub
                      </Button>
                    </a>
                  </div>
